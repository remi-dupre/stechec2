...
extern "C" error api_play(position pos) { return api->play(pos); }

/// Returns your team number
extern "C" int api_my_team() { return api->my_team(); }

/// Returns the TicTacToe board
extern "C" std::vector<int> api_board() { return api->board(); }

/// Cancels the last played action
extern "C" bool api_cancel() { return api->cancel(); }
...
extern "C" void api_afficher_error(error v) { std::cerr << v << std::endl; }
