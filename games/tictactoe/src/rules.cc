...
void Rules::spectator_turn() { champion_play_turn_(); }
...
GameState& Rules::game_state() { return api_->game_state(); }

const GameState& Rules::game_state() const { return api_->game_state(); }
