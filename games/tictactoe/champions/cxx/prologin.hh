...
static inline error play(position pos) { return api_play(pos); }

/// Returns your team number
extern "C" int api_my_team();
static inline int my_team() { return api_my_team(); }

/// Returns the TicTacToe board
extern "C" std::vector<int> api_board();
static inline std::vector<int> board() { return api_board(); }

/// Cancels the last played action
extern "C" bool api_cancel();
static inline bool cancel() { return api_cancel(); }

/// Affiche le contenu d'une valeur de type error
extern "C" void api_afficher_error(error v);
static inline void afficher_error(error v) { api_afficher_error(v); }

/// Affiche le contenu d'une valeur de type position
extern "C" void api_afficher_position(position v);
static inline void afficher_position(position v) { api_afficher_position(v); }
